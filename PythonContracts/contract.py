import sys
sys.path.append("/home/aaron/project/python2_env/env/lib/python2.7/site-packages")
    ...
    def checker(self, method_name):
        ...
        def checker_decorator(function):
            ...
            def function_wrapper(inputs, reference_inputs, parameters, outputs, returns, dependencies):
                return jsonify(
                    {'success': function(inputs, reference_inputs, parameters, outputs, returns, dependencies)})
